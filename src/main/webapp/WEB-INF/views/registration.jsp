 	...
 	<div class="generic-container">
		...
		<div class="well lead">User Registration Form</div>
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="office.id">Office</label>
					<div class="col-md-7">
						<form:select path="office.id" items="${offices}" multiple="false" itemValue="id" itemLabel="title" class="form-control input-sm" />
						<div class="has-error">
							<form:errors path="office.id" class="help-inline"/>
						</div>
					</div>
				</div>
			</div>
