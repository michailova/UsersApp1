...
public class AppController {
	...
	public String newUser(ModelMap model) {
		...
		//model.addAttribute("office-id", user.getOffice().getId());
	...
	public String saveUser(@Valid User user, BindingResult result,
		...
		MailService.send(user.getEmail(), "welcome","welcome");
		if (result.hasErrors()) {
			return "registration";
		}
	...
	public String getUserOffice(@PathVariable int id, ModelMap model) {
